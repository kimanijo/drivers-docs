...
If you want to automate the capture of your calibration files or if you're searching for the best way to remotely open and close your telescope, you can add the optional ALTO telescope cover motor and use  [GIOTTO](https://stellarmate.com/individuals/devices/covers-light-sources/primaluce-giotto.html)  as a remotely controlled motorized cap! Primaluce designed ALTO to be easily connected with our PLUS clamp to any Vixen or Losmandy style dovetail bar that is already present in many telescopes (like SCT, Aplanatic SCT, RCT, etc).
