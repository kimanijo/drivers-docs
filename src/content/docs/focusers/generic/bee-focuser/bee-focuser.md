...
title: Bee Focuser
categories: ["focusers"]
description: Bee Focuser
thumbnail: ./bee-focuser.webp
---

## Features

Beefocused is an Open Source Hardware/ Software Telescope Focuser The goal of the project is to create a high quality DIY focuser that's relatively easy to build and modify. It is  [fully open sourced](https://github.com/glowmouse/beefocus).
...
![alt text](./images/con_sim.webp "Selecting a Simulated Connection")
...
![alt text](./images/con_sim_main.webp "Simulated Focuser Connection Menu")

![alt text](./images/con_sim_main_online.webp "Simulated Focuser Online")
...
![alt text](./images/con_sim_main_moving.webp "Simulated Focuser Moving")
...
![alt text](./images/con_sim_main_move_oob.webp "Out of bounds error message")
...
[![alt text] "Sync Before")](./images/con_sim_abs_dst_sync_before.webp) 

![alt text](./images/con_sim_abs_dst_sync_after.webp)Sync After"
...
![alt text](./images/con_sim_main_rel_move.webp "Relative Move +2000")
...
![alt text](./images/con_sim_main_rel_move_in.webp "Relative Move -2000")
...
![alt text](./images/options.webp "options")
...
![alt text](./images/joystick.webp "joystick")
...
![alt text](./images/presets.webp "Presets")
...
![alt text](./images/con_eth.webp "Ethernet Connection")

The main control tab of the actual focuser and simulated focuser are the same.

![alt text](./images/con_eth_main.webp "Ethernet Main Tab ")