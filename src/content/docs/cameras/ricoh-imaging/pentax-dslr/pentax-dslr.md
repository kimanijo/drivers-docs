...
title: Pentax DSLR
categories: ["cameras"]
description: Pentax DSLR (Native)
thumbnail: ./pentax-dslr.webp
---
...
In general, a greater number of cameras are supported in MSC mode. However, in certain use cases on more recent cameras (e.g. no bulb mode, no prime focus), PTP mode is more reliable and will get you live view as well.
...
## [](https://github.com/indilib/indi-3rdparty/tree/master/indi-pentax#features)Features
...
## [](https://github.com/indilib/indi-3rdparty/tree/master/indi-pentax#operation)Operation
...
### [](https://github.com/indilib/indi-3rdparty/tree/master/indi-pentax#switching-operational-modes)Switching operational modes
...
## [](https://github.com/indilib/indi-3rdparty/tree/master/indi-pentax#known-issues)Known Issues

### [](https://github.com/indilib/indi-3rdparty/tree/master/indi-pentax#all-modes)All modes
...
### [](https://github.com/indilib/indi-3rdparty/tree/master/indi-pentax#ptp-mode-only)PTP mode only
...
### [](https://github.com/indilib/indi-3rdparty/tree/master/indi-pentax#msc-mode-only)MSC mode only
